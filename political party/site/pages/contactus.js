    ...
    <>
      ...
      <Container css={{ marginTop: gridSize * 3 }}>
        ...
        <div css={{
         ...
         <p><h3 css={{display:'inline',}}><SocialIcon url="https://mail.google.com/mail" style={{ height: 30, width: 30}} /> E-mail: </h3> <a href={`mailto:${meetup.email}`} passHref={true}>{meetup.email}</a></p>  
