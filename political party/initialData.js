...
console.log(initialData.User[0].email);
console.log(initialData.User[0].password);
console.log(initialData.User[1].email);
console.log(initialData.User[1].password);
