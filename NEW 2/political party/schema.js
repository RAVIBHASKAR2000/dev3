...
export const createLists = keystone => {
  keystone.createList('User', {
    ...
    fields: {
      ...
      yourcity: {type: Relationship, ref: 'City.user', many: false },
      role: {
        type: Select,
  ...
  keystone.createList('Organisation', {
    access: defaultAccess,
    fields: {
      OrgName: {type: Text},

      city: {type: Relationship, ref: 'City'},
      ...
      orgLevel: { type: Select,
              options: ['National', 'State', 'District'],
              defaultValue: 'District',},
      
      role: { type: Select,
            options: ['Director', 'Representative', 'Worker'],
             defaultValue: 'Worker',},
